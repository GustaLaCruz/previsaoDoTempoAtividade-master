...
export default function App() {
   ...
   async function loadUf() {
    ...
    async function carregaCity(){
        const response = await Api.get('weather?array_limit=1&fields=only_results,temp,city_name,forecast,max,min,description,date&key=ddce6cfe&city_name='+inputCity+','+uf);
